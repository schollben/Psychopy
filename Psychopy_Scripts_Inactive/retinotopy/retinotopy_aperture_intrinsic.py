...
gratingStim=visual.GratingStim(myWin,mask='None', units='pix', tex='sqr', 
    size=[200,2000], sf=0.008,contrast=1, pos=[0,0],
    autoLog=False)
...
for trial in range(0,numTrials): 
    ...
    numBlocks = 10 #retinotopic grid 6x3 = 320x320 pixels on each screen
    ...
    for block in allBlocks:
        ...
        for numOri in range(0,len(orientations)):
            ...
            if block<7:
                ...
                position = [-1920+(320/2)+320*(block-1-6) ,0]
            else:
                position = [-1920+(320/2)+320*(block-1-12) , -540+(320/2)]
