...
orientation = 0
stimSize = 22
centerPoint = [-61,10] #screen about 113. deg wide and XX deg tall
...
#set up combinations
#fudge to try and equalize distribution drawing from (less center bars and more edges)????
#if numBars==7:
#    bar1NumSingle = [0,0,1,2,4,5,6,6]
#if numBars==9:
#    bar1NumSingle = [0,0,1,2,6,7,8,8]
#if numBars==11:
#    bar1NumSingle = [0,0,1,2,8,9,10,10]
...
#bar1Num3 = numpy.arange(0,numBars-3,1)
#bar2Num3 = numpy.arange(0+3,numBars,1)
bar1Num = numpy.concatenate((bar1NumSingle,bar1Num1,bar1Num2))
bar2Num = numpy.concatenate((bar1NumSingle,bar2Num1,bar2Num2))
#bar1Num4 = numpy.arange(0,numBars-4,1)
#bar2Num4 = numpy.arange(0+4,numBars,1)
#bar1Num = numpy.concatenate((bar1NumSingle,bar1Num1,bar1Num2,bar1Num3,bar1Num4))
#bar2Num = numpy.concatenate((bar1NumSingle,bar2Num1,bar2Num2,bar2Num3,bar2Num4))
print bar1Num
print bar2Num
print len(bar1Num)
