...
ori1 = numpy.ones(numphases+2) * 90
ori2 = numpy.ones(numphases+2) * 270
...
stimSize = [130,130] #Size of grating in degrees, basically full field
...
for trial in range(0,numTrials): 
    ...
    for stimNumber in stimOrder:
        ...
        while clock.getTime()<stimDuration:
            ...
            gratingStim2.setPhase(0 + time*(temporalFreq*2))
