...
meanContVal =  0.80                               #high luminance [0,-0.9]
...
grat2Lumt = numpy.loadtxt('C:/Users/fitzlab1/Desktop/psychopy/binocgrating/binocMismatchParams/dataType_4.txt')
...
for trial in range(0,numTrials):
    ...
    for stimNumber in stimIDs:
        ...
        luminanceRangeR = grat1cont[stimNumber]
        ...
        luminanceRangeL = grat2cont[stimNumber]
