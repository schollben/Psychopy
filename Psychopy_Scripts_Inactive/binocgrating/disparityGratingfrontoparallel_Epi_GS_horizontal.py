...
changeDirectionAt = .5  #1 no reversal
stimDuration = 2
isi = 2
isRandom = 1
initialDelay= 1
...
stimSize = [120,120] #Size of grating in degrees, basically full field (132 for no mask)
centerpos = 63#68 #visual degrees off by 2 (33.15 x 2)
...
for trial in range(0,numTrials): 
    ...
    for stimNumber in stimOrder:
        ...
        if stimNumber==blankID:
            ...
            gratingStim2.ori = orientations[stimNumber]#-90+180 # which is correct?
