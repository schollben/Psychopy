...
orientations1=numpy.concatenate((ori1,ori1,ori1,nulls,ori1,nulls,ori1,nulls,ori1));
orientations2=numpy.concatenate((ori2,ori2,ori2,ori2,nulls,ori2,nulls,ori2,nulls));
speeds = numpy.concatenate((speed1,speed2,speed3,speed1,speed1,speed2,speed2,speed3,speed3))
    ...
    for stimNumber in stimOrder:
        ...
        while clock.getTime()<stimDuration:
            ...
            if clrctr%2==1:
                ...
                flipStim.setContrast(1)
            #drift stimulus here
            gratingStim1.setPhase(0+clock.getTime()*temporalFreq)
            gratingStim2.setPhase(0+clock.getTime()*temporalFreq)
