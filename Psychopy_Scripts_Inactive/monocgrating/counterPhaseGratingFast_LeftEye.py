...
# ---------- Stimulus Parameters ---------- #
ori1=numpy.ones((8,),dtype=numpy.int)*0
ori2=numpy.ones((8,),dtype=numpy.int)*45
ori3=numpy.ones((8,),dtype=numpy.int)*90
ori4=numpy.ones((8,),dtype=numpy.int)*135
orientations = numpy.concatenate((ori1,ori2,ori3,ori4))
print orientations
phase = numpy.arange(0,.5,0.0625)
...
gratingStim = visual.GratingStim(win=myWin,tex='sin',units='deg',
    pos=[-67,0],size=[150,150], sf=0.1, contrast=1, autoLog=False)
...
flipStim = visual.PatchStim(win=myWin,tex=barTexture,mask='None',units='pix',pos=[-1920,540],size=(10,10))
