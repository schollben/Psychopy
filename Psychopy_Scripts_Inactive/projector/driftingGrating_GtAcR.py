...
boardNum = 1
baseState = 0
maxPower = .75# maximum power in decimal (ranges from 0 to 1)
...
for trial in range(0,numTrials): 
    ...
    for stimNumber in stimOrder[trial,:]:
        if stimNumber>numOrientations:           
            ...
            while optoClock.getTime()<rampTime:
#                print optoClock.getTime()
                dataValue = UL.cbFromEngUnits(boardNum, gain, 4.096*maxPower*optoClock.getTime()/rampTime, 0)
#                print dataValue
