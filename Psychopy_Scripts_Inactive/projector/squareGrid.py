...
#---------- Parameters----------#
nTrials = 10
stimDuration = 0.2    # length of time each dot appears in seconds
isi =0 # length of inter stimulus interval in seconds
winSize =240# window size in pixels
spotSize  =25   # size of illumination spot in pixels->> 20 pix is ~100um FWHM-------- 25px = 100 um (2017-02)
...
isCalibration = 1 # flag to do calibration after recording
...
myWin = visual.Window(size=(1024,768),pos=(0,0),monitor=mon,fullscr=True,screen=1, allowGUI=True, waitBlanking=True)
