...
serialPortName = 'COM1' # ignored if triggerType is "COM3"
...
# ---------- Stimulus Parameters ---------- #
numTrials = 10# 10  #Run all the stims this many times
...
#make a window
myWin = visual.Window(size=[3840,1080],monitor=mon,fullscr=True,screen=2, allowGUI=False, waitBlanking=False)
myProjectorWin = visual.Window(size=(projectorWinSize),pos=(0,0),monitor=mon1,fullscr=True,screen=1, allowGUI=True, waitBlanking=True,color =[-1,-1,-1])

#set up box stimuli
boxStim = visual.Rect(win=myProjectorWin, units='pix', size=2000, pos=([cellPosX,cellPosY]), lineColor = [-1,-1,-1], fillColor =[1,1,1],lineWidth = 1)
boxStim.setAutoDraw(True)
boxStim2 = visual.Rect(win=myProjectorWin, units='pix', size=1, pos=([cellPosX,cellPosY]), lineColor = [-1,-1,-1], fillColor =[-1,-1,-1],lineWidth = 1)
boxStim2.setAutoDraw(True)
