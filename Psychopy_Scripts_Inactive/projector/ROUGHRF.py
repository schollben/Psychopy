...
#----------- Window Config -----------#
myWin = visual.Window(monitor='projector',
    size=(1024,768),
    fullscr=True,
    allowGUI = False,
    screen=1,
    ...
    color = [-1,-1,-1]) 
spotSize = 30
stim = visual.Rect(win=myWin, units='pix', size=spotSize, pos=(0,0), lineColor = 'white', fillColor = 'white')
stim.setAutoDraw(True)
#INITIALISE SOME STIMULI

increment = 30	# initial increment for moving stims
